         ...
         */
{
    ...
    class MonsterConverter : boilerplate_converter
        {
    ...
    class ACConverter : boilerplate_converter {
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer) {
    ...
    class CrConverter : boilerplate_converter{       
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            if (jtoken.Type == JTokenType.String)
            {
                ...
                return new cr_object { cr = rating };

            }
            else
            {
                return jtoken.ToObject<cr_object>();
            }
    ...
    /// </summary>
    class _copyConverter : boilerplate_converter
    {
    ...
    //INTERMEDIATE CLASS for json converters - since the first 3 overrides are exactly the same for all of them
     class boilerplate_converter : JsonConverter
    {
        #region boilerplate jsonconverter stuff
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
