...
public class WebAppWithDatabaseFixture : IAsyncLifetime, IWebAppClient
{
    ...
    private IFutureDockerImage FrontendImage;
    ...
    public async Task InitializeAsync()
    {
        ...
        this.FrontendImage = new ImageFromDockerfileBuilder()
            .WithDockerfileDirectory(Path.Combine(CommonDirectoryPath.GetSolutionDirectory().DirectoryPath, "./apps/TakeInitiative.Web"))
