<template>
    <dialog
        ref="dialog"
        @click="onModalClick"
        class="relative mt-20 w-full overflow-visible overflow-y-auto rounded-xl border border-take-yellow-dark bg-take-purple-very-dark p-5 sm:w-full md:w-3/4 lg:w-3/5"
    >
