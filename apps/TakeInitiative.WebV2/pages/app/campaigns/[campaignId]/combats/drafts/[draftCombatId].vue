        ...
        <div class="flex gap-2 items-center">
            ...
            <form>
                <FormFieldWrapper
                    ...
                    <template #Header>
                        <AsyncSuccessIcon
                            :state="debouncedSubmitUpdateCombatName.state.value"/>
                    </template>
                    <template #default>
                        <Input
                            v-model="combatName"
                            class="bg-background"
                            @input="debouncedSubmitUpdateCombatName.debouncedSubmit"/>
                    </template>
                </FormFieldWrapper>
            </form>
...
const debouncedSubmitUpdateCombatName = useDebouncedAsyncFn(submitUpdateCombatName, {
